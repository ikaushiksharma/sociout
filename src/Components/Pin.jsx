  ...
  return (
    <div className="m-2">
      <div
        ...
        className="relative w-auto overflow-hidden transition-all duration-500 ease-in-out rounded-lg cursor-zoom-in hover:shadow-lg dark:hover:shadow-gray-500"
      >
        {image && (
          <img
      ...
      >
        <img
          ...
          alt="user-profile"
        />
        <p className="font-semibold dark:text-white dark:opacity-70 capitalize">
          {postedBy?.userName}
        </p>
      </Link>
    </div>
